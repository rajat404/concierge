...
## Setting up concierge with Drone.io Continuous Integration
...
5. Select ` concierge ` for your repo
...
psql -c "CREATE DATABASE concierge;" -U postgres
...
1. Click ( "Deployment" )[https://drone.io/github.com/rajat/concierge/admin/deployments#/]
...
4. Add `https://git.heroku.com:concierge-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - concierge-qa for branch qa
    - concierge-prod for branch prod
