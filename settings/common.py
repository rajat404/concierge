...
APPS_DIR = ROOT_DIR.path('concierge')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'concierge.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/concierge'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'concierge.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'concierge.base.views.csrf_failure'
