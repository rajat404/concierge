...
def celery():
    ...
    install_requirements()
    migrate()
    local('celery worker -A concierge -B -l INFO --concurrency=2')
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['qa.concierge.com']
    env.dotenv_path = '/home/ubuntu/dev/concierge/.env'
...
def qa():
    ...
    env.branch = 'qa'
    env.hosts = ['qa.concierge.com']
    env.dotenv_path = '/home/ubuntu/qa/concierge/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.concierge.com']
    env.dotenv_path = '/home/ubuntu/prod/concierge/.env'
    env.config_setter = fab.run
